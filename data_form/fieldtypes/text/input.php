...
if($FieldSet[1] == 'emailaddress'){
    ...
    $Return .= '<input name="dataForm['.$Element['ID'].']['.$Field.']" type="textfield" '.$disabled.' id="entry_'.$Element['ID'].'_'.$Field.'" value="'.$Val.'" class="'.$Req.' '.$Config['_FormFieldWidth'][$Field].'"/>';
...
if($FieldSet[1] == 'telephonenumber'){
	...
	echo '<input name="dataForm['.$Element['ID'].']['.$Field.']" type="textfield" id="entry_'.$Element['ID'].'_'.$Field.'" value="'.$Val.'" class="'.$Req.' '.$Config['_FormFieldWidth'][$Field].'" />';
}
...
if($FieldSet[1] == 'colourpicker'){
    ...
    $Return .= '<input name="dataForm['.$Element['ID'].']['.$Field.']" type="textfield" id="entry_'.$Element['ID'].'_'.$Field.'" value="'.$Val.'" class="'.$Req.' input-small" style="width:60px;" '.$WidthOverride.' />';
    $Return .= '</div>';
    echo $Return;
