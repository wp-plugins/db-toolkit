...
function file_filesetup($Field, $Table, $Config = false) {
    ...
    $Return .= 'AWS AccessKey: <input type="textfield" value="' . $accessKey . '" name="Data[Content][_AWSAccessKey][' . $Field . ']" ' . $sel . ' /><br />';
    $Return .= 'AWS SecretKey: <input type="textfield" value="' . $secretKey . '" name="Data[Content][_AWSSecretKey][' . $Field . ']" ' . $sel . ' /><br />';
