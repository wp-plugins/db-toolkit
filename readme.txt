...
= 0.3.2.013 =
* Fixed a few minor bugs. A full update will be coming in a few days.

= 0.3.2.012 =
* Fixed a bug in the validation that would not validate correctly an image field and fail the capture.
