                ...
                if(!empty($SetupView)) {
                    foreach($SetupView as $preRow=>$Columns) {
                        ...
                        if(substr($preRow,0,7) == 'viewrow') {
                            ...
                            $view .= '<img src="'.WP_PLUGIN_URL.'/dbtoolkit/data_report/cog.png" style="cursor:pointer;" width="16" height="16" onclick="viewSetupColumns(\''.$Row.'\');" /><img src="'.WP_PLUGIN_URL.'/dbtoolkit/data_report/add.png" style="cursor:pointer;" width="16" height="16" onclick="viewAddColumn(\''.$Row.'\');" /><img src="'.WP_PLUGIN_URL.'/dbtoolkit/data_report/delete.png" style="cursor:pointer;" width="16" height="16" onclick="viewSubtractColumn(\''.$Row.'\');" />';
                            if($Index > 1) {
                                $view .= '<img src="'.WP_PLUGIN_URL.'/dbtoolkit/data_report/no.png" style="cursor:pointer;" width="16" height="16" onclick="viewRemoveColumns(\''.$Row.'\');" />';
                            }
                            $view .= '</div>';
